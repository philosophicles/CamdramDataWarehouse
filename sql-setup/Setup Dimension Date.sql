...
drop procedure if exists camdram_dw.setup_dim_date;
delimiter @
create procedure camdram_dw.setup_dim_date()
begin

	drop table if exists camdram_dw.dim_date;
	create table camdram_dw.dim_date (
    ...
    update 		camdram_dw.dim_date 				D
    inner join 	camdram_dw.extractv_dim_date_terms	T	on D.DateValue >= T.TermStartDate
