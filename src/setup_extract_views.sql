...
drop view if exists `extractv_dim_date_terms`;
CREATE VIEW `extractv_dim_date_terms` AS
	SELECT 
...
drop view if exists `extractv_dim_society_official`;
CREATE VIEW `extractv_dim_society_official` AS
	SELECT 
...
drop view if exists `extractv_dim_story`;
CREATE VIEW `extractv_dim_story` AS
	select	distinct
...
drop view if exists `extractv_dim_user`;
CREATE VIEW `extractv_dim_user` AS
	SELECT 
...
drop view if exists `extractv_dim_venue_free`;
CREATE VIEW `extractv_dim_venue_free` AS
	SELECT DISTINCT
...
drop view if exists `extractv_dim_venue_official`;
CREATE VIEW `extractv_dim_venue_official` AS
	SELECT 
		id AS `VenueId`,
		name AS `VenueName`,
...
drop view if exists extractv_fct_roles;
create view extractv_fct_roles as 
	/*
